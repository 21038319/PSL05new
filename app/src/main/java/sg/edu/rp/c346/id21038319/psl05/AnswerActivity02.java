...
public class AnswerActivity02 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_answer02);
...
//        tvAnswer.setText("In second activity");
        ...
        double questionsSelected5 = intentReceived.getDoubleExtra("Credit", 0.0);
